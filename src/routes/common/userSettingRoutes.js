...
const { UpdateUserAvatar, UpdateUserDetails, addDeviceId } = require('../../controllers/common/userSettingController');
...
module.exports = () => {
    ...
    router.post('/device_id/:id',  authenticate, addDeviceId)
    return router;
};
